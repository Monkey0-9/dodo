...
def test_check_existing_provider_success(client: dodo, test_provider):
...
def test_check_existing_provider_not_found(client: dodo):
...
def test_check_existing_provider_unauthorized(client: dodo, test_provider):
