...
@pytest.fixture(scope="module")
def client(server_url: str) -> Generator[dodo, None, None]:
    """
...
@pytest.fixture(scope="function")
def agent_with_gpt4o_mini(client: dodo) -> Generator[AgentState, None, None]:
    """
...
@pytest.fixture(scope="function")
def agent_with_gemini(client: dodo) -> Generator[AgentState, None, None]:
    """
