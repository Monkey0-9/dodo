...
from dodo.schemas.dodo_message_content import Base64Image, ImageContent, TextContent, UrlImage
...
async def test_convert_message_creates_to_messages_rejects_file_image_urls():
    ...
    with pytest.raises(dodoInvalidArgumentError, match="Unsupported image URL scheme 'file'"):
