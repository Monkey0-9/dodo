...
from dodo.embeddings import GoogleEmbeddings  # type: ignore[import-untyped]  # Adjust the import based on your module structure
...
from dodo.client import CreateBlock, MessageCreate, dodo as dodoSDKClient
...
def client() -> dodoSDKClient:
    ...
    client = dodoSDKClient(base_url=server_url, token=None)
    yield client
...
def test_archival_insert_text_embedding_004(client: dodoSDKClient):
    """
...
def test_archival_insert_embedding_001(client: dodoSDKClient):
    """
