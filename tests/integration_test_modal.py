...
from dodo.schemas.sandbox_config import LocalSandboxConfig, ModalSandboxConfig, SandboxConfigCreate
...
from dodo.services.tool_sandbox.modal_sandbox import AsyncToolSandboxModal
...
async def test_modal_sandbox_with_broken_tool_pip_requirements_error_handling(check_modal_key_is_set, test_user):
    ...
    # expect a dodoInvalidArgumentError
