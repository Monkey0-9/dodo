...
from dodo.schemas.providers.chatgpt_oauth import CHATGPT_MODELS
...
async def test_lmstudio():
    from dodo.schemas.providers.lmstudio import LMStudioOpenAIProvider
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("openai/gpt-4o-mini", AgentType.dodo_v2_agent, True, True, True, 0, None),
        ("openai/gpt-4o-mini", AgentType.dodo_v2_agent, False, False, False, 0, None),
        ("openai/o3-mini", AgentType.dodo_v2_agent, True, True, False, 0, "medium"),
        ("openai/o3-mini", AgentType.dodo_v2_agent, False, True, False, 0, "medium"),
        ("anthropic/claude-3.5-sonnet", AgentType.dodo_v2_agent, True, True, True, 0, None),
        ("anthropic/claude-3.5-sonnet", AgentType.dodo_v2_agent, False, False, False, 0, None),
        ("anthropic/claude-3-7-sonnet", AgentType.dodo_v2_agent, True, True, False, 1024, None),
        ("anthropic/claude-3-7-sonnet", AgentType.dodo_v2_agent, False, False, False, 0, None),
        ("anthropic/claude-sonnet-4", AgentType.dodo_v2_agent, True, True, False, 1024, None),
        ("anthropic/claude-sonnet-4", AgentType.dodo_v2_agent, False, False, False, 0, None),
        # Opus 4.6 / Sonnet 4.6 use adaptive thinking - max_reasoning_tokens should stay 0
        ("anthropic/claude-opus-4-6", AgentType.dodo_v2_agent, True, True, False, 0, None),
        ("anthropic/claude-opus-4-6", AgentType.dodo_v2_agent, False, False, False, 0, None),
        ("anthropic/claude-sonnet-4-6", AgentType.dodo_v2_agent, True, True, False, 0, None),
        ("anthropic/claude-sonnet-4-6", AgentType.dodo_v2_agent, False, False, False, 0, None),
        ("google_vertex/gemini-2.0-flash", AgentType.dodo_v2_agent, True, True, True, 0, None),
        ("google_vertex/gemini-2.0-flash", AgentType.dodo_v2_agent, False, False, False, 0, None),
        ("google_vertex/gemini-2.5-flash", AgentType.dodo_v2_agent, True, True, True, 1024, None),
        ("google_vertex/gemini-2.5-flash", AgentType.dodo_v2_agent, False, False, False, 0, None),
        ("google_vertex/gemini-2.5-pro", AgentType.dodo_v2_agent, True, True, True, 1024, None),
        ("google_vertex/gemini-2.5-pro", AgentType.dodo_v2_agent, True, True, True, 1024, None),
        # dodo_v1_agent loop
        ("openai/gpt-4o-mini", AgentType.dodo_v1_agent, True, False, False, 0, None),
        ("openai/gpt-4o-mini", AgentType.dodo_v1_agent, False, False, False, 0, None),
        ("openai/o3-mini", AgentType.dodo_v1_agent, True, True, False, 0, "medium"),
        ("openai/o3-mini", AgentType.dodo_v1_agent, False, True, False, 0, "medium"),
        ("anthropic/claude-3.5-sonnet", AgentType.dodo_v1_agent, True, False, False, 0, None),
        ("anthropic/claude-3.5-sonnet", AgentType.dodo_v1_agent, False, False, False, 0, None),
        ("anthropic/claude-3-7-sonnet", AgentType.dodo_v1_agent, True, True, False, 1024, None),
        ("anthropic/claude-3-7-sonnet", AgentType.dodo_v1_agent, False, False, False, 0, None),
        ("anthropic/claude-sonnet-4", AgentType.dodo_v1_agent, True, True, False, 1024, None),
        ("anthropic/claude-sonnet-4", AgentType.dodo_v1_agent, False, False, False, 0, None),
        # Opus 4.6 / Sonnet 4.6 use adaptive thinking - max_reasoning_tokens should stay 0
        ("anthropic/claude-opus-4-6", AgentType.dodo_v1_agent, True, True, False, 0, None),
        ("anthropic/claude-opus-4-6", AgentType.dodo_v1_agent, False, False, False, 0, None),
        ("anthropic/claude-sonnet-4-6", AgentType.dodo_v1_agent, True, True, False, 0, None),
        ("anthropic/claude-sonnet-4-6", AgentType.dodo_v1_agent, False, False, False, 0, None),
        ("google_vertex/gemini-2.0-flash", AgentType.dodo_v1_agent, True, False, False, 0, None),
        ("google_vertex/gemini-2.0-flash", AgentType.dodo_v1_agent, False, False, False, 0, None),
        ("google_vertex/gemini-2.5-flash", AgentType.dodo_v1_agent, True, True, False, 1024, None),
        ("google_vertex/gemini-2.5-flash", AgentType.dodo_v1_agent, False, False, False, 0, None),
        ("google_vertex/gemini-2.5-pro", AgentType.dodo_v1_agent, True, True, False, 1024, None),
        ("google_vertex/gemini-2.5-pro", AgentType.dodo_v1_agent, False, True, False, 1024, None),
    ],
)
...
def test_codex_default_reasoning_effort():
    ...
    new_config = LLMConfig.apply_reasoning_setting_to_config(config, reasoning=True, agent_type=AgentType.dodo_v2_agent)
    ...
    new_config = LLMConfig.apply_reasoning_setting_to_config(config, reasoning=False, agent_type=AgentType.dodo_v2_agent)
    assert new_config.reasoning_effort == "medium", "gpt-5-codex should default to 'medium', not 'minimal'"

    # For v1 agent with reasoning=True
    new_config = LLMConfig.apply_reasoning_setting_to_config(config, reasoning=True, agent_type=AgentType.dodo_v1_agent)
    assert new_config.reasoning_effort == "medium", "gpt-5-codex should default to 'medium', not 'minimal'"
