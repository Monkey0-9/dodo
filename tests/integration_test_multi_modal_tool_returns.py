...
from dodo.client.types import ApprovalRequestMessage, AssistantMessage
...
class TestMultiModalToolReturns:
    ...
    def test_model_can_see_image_in_tool_return(self, client: dodo, model: str) -> None:
        """
    ...
    def test_model_without_image_support_gets_placeholder(self, client: dodo, model: str) -> None:
        """
...
class TestMultiModalToolReturnsSerialization:
    ...
    def test_tool_return_with_image_persists_in_db(self, client: dodo, model: str) -> None:
        """
