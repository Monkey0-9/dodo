...
from dodo.functions.mcp_client.types import MCPServerType, SSEServerConfig, StreamableHTTPServerConfig
from dodo.helpers.url_validation import validate_mcp_server_url
from dodo.schemas.mcp import MCPServer
from dodo.schemas.mcp_server import CreateMCPServerRequest
...
def test_validate_mcp_server_url_allows_public_hostname():
    with patch("dodo.helpers.url_validation.socket.getaddrinfo", return_value=[(None, None, None, None, ("93.184.216.34", 443))]):
