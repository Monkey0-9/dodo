...
@pytest.fixture
def otid_test_agent(client: dodo):
...
class TestConversationsSDK:
    ...
    def test_create_conversation(self, client: dodo, agent):
    ...
    def test_list_conversations(self, client: dodo, agent):
    ...
    def test_list_conversations_sort_by_last_message_at(self, client: dodo, agent):
    ...
    def test_retrieve_conversation(self, client: dodo, agent):
    ...
    def test_default_system_message_metadata_has_agent_and_default_conversation(self, client: dodo, agent, server_url: str):
    ...
    def test_conversation_system_message_metadata_has_agent_and_conversation_id(self, client: dodo, agent, server_url: str):
    ...
    def test_client_skills_are_rendered_in_conversation_system_prompt(self, client: dodo, agent, server_url: str):
    ...
    def test_send_message_to_conversation(self, client: dodo, agent):
    ...
    def test_list_conversation_messages(self, client: dodo, agent):
    ...
    def test_conversation_isolation(self, client: dodo, agent):
    ...
    def test_fork_conversation_via_rest_shares_non_system_message_ids(self, client: dodo, agent, server_url: str):
    ...
    def test_fork_conversation_via_rest_not_found(self, client: dodo, agent, server_url: str):
    ...
    def test_conversation_messages_pagination(self, client: dodo, agent):
        ...
        # List with limit â€” access the first page directly (not list() which auto-paginates)
    ...
    def test_conversation_lock_released_after_completion(self, client: dodo, agent):
    ...
    def test_conversation_lock_released_on_error(self, client: dodo, agent):
    ...
    def test_concurrent_messages_to_same_conversation(self, client: dodo, agent):
    ...
    def test_list_conversation_messages_order_asc(self, client: dodo, agent):
    ...
    def test_list_conversation_messages_order_desc(self, client: dodo, agent):
    ...
    def test_list_conversation_messages_order_affects_pagination(self, client: dodo, agent):
    ...
    def test_list_conversation_messages_with_before_cursor(self, client: dodo, agent):
    ...
    def test_list_conversation_messages_with_after_cursor(self, client: dodo, agent):
    ...
    def test_agent_direct_messaging_via_conversations_endpoint(self, client: dodo, agent):
    ...
    def test_agent_direct_messaging_with_locking(self, client: dodo, agent):
    ...
    def test_agent_direct_concurrent_requests_blocked(self, client: dodo, agent):
    ...
    def test_agent_direct_list_messages(self, client: dodo, agent):
    ...
    def test_agent_direct_cancel(self, client: dodo, agent):
    ...
    def test_backwards_compatibility_old_pattern(self, client: dodo, agent, server_url: str):
    ...
    def test_new_pattern_default_system_message_metadata(self, client: dodo, agent, server_url: str):
    ...
    def test_new_pattern_send_message(self, client: dodo, agent, server_url: str):
    ...
    def test_new_pattern_list_messages(self, client: dodo, agent, server_url: str):
    ...
    def test_new_pattern_cancel(self, client: dodo, agent, server_url: str):
    ...
    def test_new_pattern_compact(self, client: dodo, agent, server_url: str):
    ...
    def test_new_pattern_stream_retrieve(self, client: dodo, agent, server_url: str):
    ...
    def test_conversation_system_override_forces_response_content(self, client: dodo, agent, server_url: str):
    ...
    def test_default_conversation_system_override_forces_response_content(self, client: dodo, agent, server_url: str):
    ...
    def test_fork_default_conversation_via_rest(self, client: dodo, agent, server_url: str):
...
class TestConversationDelete:
    ...
    def test_delete_conversation(self, client: dodo, agent, server_url: str):
    ...
    def test_delete_conversation_removes_from_list(self, client: dodo, agent, server_url: str):
    ...
    def test_delete_conversation_not_found(self, client: dodo, agent, server_url: str):
    ...
    def test_delete_conversation_double_delete(self, client: dodo, agent, server_url: str):
    ...
    def test_update_deleted_conversation_fails(self, client: dodo, agent, server_url: str):
...
class TestConversationRecompile:
    ...
    def test_recompile_conversation_updates_existing_conversation_system_message(self, client: dodo, server_url: str):
    ...
    def test_recompile_conversation_dry_run_does_not_persist(self, client: dodo, server_url: str):
    ...
    def test_recompile_conversation_agent_direct_mode(self, client: dodo, server_url: str):
...
class TestConversationCompact:
    ...
    def test_compact_conversation_basic(self, client: dodo, agent, server_url: str):
    ...
    def test_compact_conversation_creates_summary_role_message(self, client: dodo, agent, server_url: str):
    ...
    def test_compact_conversation_with_settings(self, client: dodo, agent, server_url: str):
    ...
    def test_compact_conversation_preserves_conversation_isolation(self, client: dodo, agent, server_url: str):
    ...
    def test_compact_conversation_empty_fails(self, client: dodo, agent, server_url: str):
    ...
    def test_compact_conversation_invalid_id(self, client: dodo, agent, server_url: str):
...
class TestConversationSystemMessageRecompilation:
    ...
    def test_new_conversation_recompiles_system_message_with_updated_memory(self, client: dodo, server_url: str):
    ...
    def test_conversation_creation_initializes_system_message(self, client: dodo, server_url: str):
...
async def test_concurrent_conversation_requests_return_409(
    ...
    # If stream 1 completed before stream 2 started, stream 2 may succeed â€”
    ...
    if stream2_error is not None:
        ...
        logger.info("Stream 1 completed before stream 2 started â€” no lock contention (acceptable)")
