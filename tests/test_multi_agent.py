    ...
    agent_scooby = await server.create_agent_async(
        request=CreateAgent(
            ...
            memory_blocks=[
                CreateBlock(
                    label="persona",
                    value="You are a puppy operations agent for dodo and you help run multi-agent group chats. Your job is to get to know the agents in your group and pick who is best suited to speak next in the conversation.",
                ),
                CreateBlock(
                    label="human",
                    value="",
