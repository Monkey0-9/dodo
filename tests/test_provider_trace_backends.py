...
from dodo.services.provider_trace_backends.base import ProviderTraceBackend
from dodo.services.provider_trace_backends.socket import SocketProviderTraceBackend
...
class TestBackendFactory:
    ...
    def test_get_postgres_backend(self):
        ...
        from dodo.services.provider_trace_backends.factory import _create_backend
    ...
    def test_get_socket_backend(self):
        ...
        with patch("dodo.settings.telemetry_settings") as mock_settings:
    ...
    def test_get_multiple_backends(self):
        ...
        from dodo.services.provider_trace_backends.factory import (
        ...
        # depends on env var dodo_TELEMETRY_PROVIDER_TRACE_BACKEND
...
class TestTelemetrySettings:
    ...
    def test_provider_trace_backends_parsing(self):
        ...
        from dodo.settings import TelemetrySettings
