...
"""
    ...
    def test_no_base_instructions_tag_extracts_preamble(self):
        ...
        system_message = (
            ...
            "<memory_blocks>\n"
            "<persona>My name is dodo.</persona>\n"
            "</memory_blocks>\n\n"
    ...
    def test_dodo_code_agent_real_format(self):
        """Real-world dodo Code agent format: no base_instructions, nested memory_filesystem"""
        system_message = (
            ...
            "</memory_filesystem>\n\n"
            "<persona>\n"
            "<value>My name is dodo Code.</value>\n"
            "</persona>\n\n"
            "<human>\n"
        ...
        assert result["core_memory"] is not None
        assert "dodo Code" in result["core_memory"]
...
<memory_filesystem>
Memory Directory: ~/.dodo/agents/agent-123/memory
