...
from dodo.services.summarizer import summarizer_all, summarizer_sliding_window
from dodo.services.summarizer.enums import SummarizationMode
from dodo.services.summarizer.summarizer import Summarizer, simple_summary
...
class TestSimpleSummaryTelemetryContext:
    ...
    async def test_simple_summary_accepts_telemetry_params(self, mock_messages, mock_llm_config, mock_actor):
        ...
        with patch("dodo.services.summarizer.summarizer.LLMClient") as mock_client_class:
...
class TestSummarizerClassTelemetryContext:
    ...
    async def test_summarizer_summarize_passes_runtime_telemetry(self, mock_messages, mock_actor):
        ...
        with patch("dodo.services.summarizer.summarizer.simple_summary", new=capture_simple_summary):
            try:
