...
def extract_usage_from_stream(messages: List[Any]) -> Optional[dodoUsageStatistics]:
    """Extract dodoUsageStatistics from a stream response."""
    for msg in reversed(messages):
        if isinstance(msg, dodoUsageStatistics):
            return msg
    return None
