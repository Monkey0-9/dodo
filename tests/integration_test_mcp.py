...
@pytest.fixture(scope="function")
def agent_state(client: dodo, mcp_server_name: str, mock_mcp_server_config: StdioServerConfig) -> AgentState:
    """
...
def test_mcp_echo_tool(client: dodo, agent_state: AgentState):
    """
...
def test_mcp_add_tool(client: dodo, agent_state: AgentState):
    """
...
def test_mcp_multiple_tools_in_sequence(client: dodo, agent_state: AgentState):
    """
...
def test_mcp_server_listing(client: dodo, mcp_server_name: str, mock_mcp_server_config: StdioServerConfig):
    """
...
def test_mcp_complex_schema_tool(client: dodo, mcp_server_name: str, mock_mcp_server_config: StdioServerConfig):
    """
