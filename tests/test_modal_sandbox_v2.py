...
from dodo.schemas.sandbox_config import ModalSandboxConfig, SandboxConfig, SandboxType
...
""",
    ...
    async def test_run_with_mocked_modal(self, mock_tool, mock_user, mock_sandbox_config):
        ...
        with (
            patch("dodo.services.tool_sandbox.modal_sandbox_v2.modal") as mock_modal,
            patch("dodo.services.tool_sandbox.modal_deployment_manager.modal") as mock_modal2,
        ):
            # Mock Modal app
