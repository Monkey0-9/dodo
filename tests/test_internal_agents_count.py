...
def test_agents(client: dodo) -> List[AgentState]:
    """
...
def test_internal_agents_count_exclude_hidden(client: dodo, test_agents: List[AgentState]):
    """
...
def test_internal_agents_count_include_all(client: dodo, test_agents: List[AgentState]):
    """
...
def test_internal_agents_count_default_behavior(client: dodo, test_agents: List[AgentState]):
    """
