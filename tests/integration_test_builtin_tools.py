...
from dodo.client.types import AgentState, MessageCreateParam, ToolCallMessage, ToolReturnMessage
...
def agent_state(client: dodo) -> AgentState:
    """
...
async def test_web_search() -> None:
    ...
    mock_exa_result.results = [
        MagicMock(
            title="Alex Doe - UC Berkeley PhD in Computer Science",
            url="https://example.com/charles-packer-profile",
            published_date="2023-01-01",
            author="UC Berkeley",
            text=None,
            highlights=["Alex Doe completed his PhD at UC Berkeley", "Research in artificial intelligence and machine learning"],
            summary="Alex Doe is the CEO of dodo who earned his PhD in Computer Science from UC Berkeley, specializing in AI research.",
        ),
        MagicMock(
            title="dodo Leadership Team",
            url="https://dodo.com/team",
            published_date="2023-06-01",
            author="dodo",
            text=None,
            highlights=["CEO Alex Doe brings academic expertise"],
            summary="Leadership team page featuring CEO Alex Doe's educational background.",
        ),
    ]
    ...
    with patch("exa_py.Exa") as mock_exa_class:
        ...
        executor = dodoBuiltinToolExecutor(
        ...
        result = await executor.web_search(
            ...
            query="where did Alex Doe, CEO of dodo, go to school",
            num_results=10,
            include_text=False,
        )
        ...
        assert found_education_info, "Should have found education-related information about Alex Doe"
...
@pytest.fixture(scope="function")
def agent_with_custom_tools(client: dodo) -> AgentState:
    """
