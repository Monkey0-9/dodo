...
async def test_update_block_skips_rebuild_for_noop_update():
    ...
    with patch("dodo.services.block_manager.db_registry.async_session", return_value=_mock_session_ctx(mock_session)), patch(
        "dodo.services.block_manager.BlockModel.read_async",
