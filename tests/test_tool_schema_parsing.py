...
from dodo.functions.schema_generator import validate_google_style_docstring
from dodo.helpers.tool_execution_helper import enable_strict_mode
from dodo.llm_api.helpers import convert_to_structured_output
from dodo.schemas.tool import MCP_TOOL_METADATA_SCHEMA_STATUS, Tool
...
def test_complex_nested_anyof_schema_to_structured_output():
    ...
    try:
        ...
        print("âœ… Complex nested anyOf schema successfully converted to structured output")
