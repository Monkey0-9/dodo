...
from dodo.schemas.enums import ToolSourceType
from dodo.schemas.organization import Organization
from dodo.schemas.pip_requirement import PipRequirement
from dodo.schemas.sandbox_config import ModalSandboxConfig, SandboxConfig, SandboxConfigCreate, SandboxType
...
from dodo.services.tool_sandbox.modal_sandbox_v2 import AsyncToolSandboxModalV2
from dodo.services.tool_sandbox.modal_version_manager import ModalVersionManager, get_version_manager
...
class TestModalV2Persistence:
    ...
    async def test_deployment_persists_in_tool_metadata(self, mock_user, sandbox_config):
        ...
        with patch("dodo.services.tool_sandbox.modal_version_manager.ToolManager") as MockToolManager:
    ...
    async def test_sandbox_config_changes_trigger_redeployment(self, basic_tool, mock_user):
        ...
        with patch("dodo.services.tool_sandbox.modal_sandbox_v2.tool_settings") as mock_settings:
...
""",
        ...
        with patch("dodo.services.tool_sandbox.modal_version_manager.ToolManager") as MockToolManager:
            with patch("dodo.services.tool_sandbox.modal_sandbox_v2.modal") as mock_modal:
                mock_tool_manager = MockToolManager.return_value
                mock_tool_manager.get_tool_by_id.return_value = tool
                ...
                with patch("dodo.services.tool_sandbox.base.SandboxConfigManager") as MockSCM:
