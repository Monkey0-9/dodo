...
def client() -> dodoSDKClient:
    """Get or start a dodo server and return a client."""
...
def agent_without_embedding(client: dodoSDKClient):
...
@pytest.fixture(scope="function")
def agent_with_embedding(client: dodoSDKClient):
...
class TestAgentCreationWithoutEmbedding:
    ...
    def test_create_agent_without_embedding(self, client: dodoSDKClient):
...
class TestArchivalMemoryInsertWithoutEmbedding:
    ...
    def test_insert_passage_without_embedding(self, client: dodoSDKClient, agent_without_embedding):
    ...
    def test_insert_multiple_passages_without_embedding(self, client: dodoSDKClient, agent_without_embedding):
    ...
    def test_insert_passage_with_tags_without_embedding(self, client: dodoSDKClient, agent_without_embedding):
...
class TestArchivalMemoryListWithoutEmbedding:
    ...
    def test_list_passages_without_embedding(self, client: dodoSDKClient, agent_without_embedding):
    ...
    def test_list_passages_with_search_filter(self, client: dodoSDKClient, agent_without_embedding):
...
class TestArchivalMemorySearchWithoutEmbedding:
    ...
    def test_search_passages_without_embedding(self, client: dodoSDKClient, agent_without_embedding):
    ...
    def test_global_passage_search_without_embedding(self, client: dodoSDKClient, agent_without_embedding):
...
class TestArchivalMemoryDeleteWithoutEmbedding:
    ...
    def test_delete_passage_without_embedding(self, client: dodoSDKClient, agent_without_embedding):
...
class TestEdgeCases:
    ...
    def test_empty_archival_memory_search(self, client: dodoSDKClient, agent_without_embedding):
    ...
    def test_passage_with_special_characters(self, client: dodoSDKClient, agent_without_embedding):
    ...
    def test_very_long_passage(self, client: dodoSDKClient, agent_without_embedding):
