...
@pytest.fixture(scope="function")
def agent_with_mcp_tools(client: dodo, mock_mcp_server_config_for_agent: Dict[str, Any]) -> AgentState:
    """
    ...
    try:
        ...
        # Find the echo and add tools (they should already be in dodo's tool registry)
...
def test_create_stdio_mcp_server(client: dodo):
...
def test_create_sse_mcp_server(client: dodo):
...
def test_list_mcp_servers(client: dodo):
...
def test_get_specific_mcp_server(client: dodo):
...
def test_update_stdio_mcp_server(client: dodo):
...
def test_update_sse_mcp_server(client: dodo):
...
def test_delete_mcp_server(client: dodo):
...
def test_invalid_server_type(client: dodo):
...
def test_multiple_server_types_coexist(client: dodo):
...
def test_partial_update_preserves_fields(client: dodo):
...
def test_concurrent_server_operations(client: dodo):
...
def test_full_server_lifecycle(client: dodo):
...
def test_empty_tools_list(client: dodo):
...
def test_mcp_echo_tool_with_agent(client: dodo, agent_with_mcp_tools: AgentState):
    """
...
def test_mcp_add_tool_with_agent(client: dodo, agent_with_mcp_tools: AgentState):
    """
...
def test_mcp_multiple_tools_in_sequence_with_agent(client: dodo):
    """
...
def test_mcp_complex_schema_tool_with_agent(client: dodo):
    """
...
def test_comprehensive_mcp_server_tool_listing(client: dodo):
    """
