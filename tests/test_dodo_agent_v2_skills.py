...
def _make_agent(memory: Memory) -> dodoAgentV2:
    actor = User(
    ...
    with patch("dodo.agents.dodo_agent_v2.LLMClient.create", return_value=MagicMock()):
        return dodoAgentV2(agent_state=agent_state, actor=actor)
