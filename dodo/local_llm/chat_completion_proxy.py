...
from dodo.errors import LocalLLMConnectionError, LocalLLMError
from dodo.helpers.datetime_helpers import get_utc_time_int
from dodo.helpers.json_helpers import json_dumps
from dodo.local_llm.constants import DEFAULT_WRAPPER
from dodo.local_llm.function_parser import patch_function
from dodo.local_llm.grammars.gbnf_grammar_generator import create_dynamic_model_from_function, generate_gbnf_grammar_and_documentation
from dodo.local_llm.koboldcpp.api import get_koboldcpp_completion
from dodo.local_llm.llamacpp.api import get_llamacpp_completion
from dodo.local_llm.llm_chat_completion_wrappers import simple_summary_wrapper
from dodo.local_llm.lmstudio.api import get_lmstudio_completion, get_lmstudio_completion_chatcompletions
from dodo.local_llm.ollama.api import get_ollama_completion
from dodo.local_llm.utils import get_available_wrappers
from dodo.local_llm.vllm.api import get_vllm_completion
from dodo.local_llm.webui.api import get_webui_completion
from dodo.local_llm.webui.legacy_api import get_webui_completion as get_webui_completion_legacy
from dodo.otel.tracing import log_event
from dodo.prompts.gpt_summarize import SYSTEM as SUMMARIZE_SYSTEM_MESSAGE
from dodo.schemas.message import Message as PydanticMessage
from dodo.schemas.openai.chat_completion_response import ChatCompletionResponse, Choice, Message, ToolCall, UsageStatistics
from dodo.utils import get_tool_call_id
...
def get_chat_completion(
    ...
    if grammar is not None and endpoint_type not in grammar_supported_backends:
        print(
            f"{CLI_WARNING_PREFIX}grammars are currently not supported when using {endpoint_type} as the dodo local LLM backend (supported: {', '.join(grammar_supported_backends)})"
        )
        grammar = None
