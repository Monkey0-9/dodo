...
from dodo.local_llm.settings.deterministic_mirostat import settings as det_miro_settings
from dodo.local_llm.settings.simple import settings as simple_settings
...
def get_completions_settings(defaults="simple") -> dict:
    ...
    settings_dir = os.path.join(dodo_DIR, SETTINGS_FOLDER_NAME)
