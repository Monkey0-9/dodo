...
if TYPE_CHECKING:
    from dodo.agents.dodo_agent import dodoAgent as Agent
...
def memory(
    ...
    """
    raise NotImplementedError("This should never be invoked directly. Contact dodo if you see this error message.")
...
def conversation_search(
    ...
    from dodo.constants import RETRIEVAL_QUERY_DEFAULT_PAGE_SIZE
...
def memory_replace(agent_state: "AgentState", label: str, old_string: str, new_string: str) -> str:  # type: ignore
    ...
    Examples:
        ...
        memory_replace(label="human", old_string="# NOTE: Line numbers shown below (with arrows like '1â†’') are to help during editing. Do NOT include line number prefixes in your memory edit tool calls.\\n1â†’ Their name is Alice", new_string="1â†’ Their name is Bob")
...
def memory_apply_patch(agent_state: "AgentState", label: str, patch: str) -> str:  # type: ignore
    ...
    - Do not include line number prefixes like "12â†’" anywhere in the patch. Line numbers are for display only.
