...
def run_code(code: str, language: Literal["python", "js", "ts", "r", "java"]) -> str:
    ...
    raise NotImplementedError("This is only available on the latest agent architecture. Please contact the dodo team.")
...
async def web_search(
    ...
    web_search("dodo API documentation core_memory_append", num_results=3)
