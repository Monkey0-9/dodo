...
from dodo.constants import REQUEST_HEARTBEAT_DESCRIPTION, REQUEST_HEARTBEAT_PARAM, TOOL_RESERVED_KWARGS
...
def generate_schema(function, name: Optional[str] = None, description: Optional[str] = None, tool_id: Optional[str] = None) -> dict:
    ...
    for param in sig.parameters.values():
        ...
        if (
            ...
            # logger.info("Generating schema for pydantic model:", param.annotation)
        ...
        #                   however in that
            ...
            # logger.info("Generating schema for non-pydantic model:", param.annotation)
