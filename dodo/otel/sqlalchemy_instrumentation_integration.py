...
This module provides easy integration with the existing dodo application,
...
from dodo.otel.sqlalchemy_instrumentation import (
...
def setup_dodo_db_instrumentation(
    enable_joined_monitoring: bool = True,
    sql_truncate_length: int = 1000,
    additional_config: Optional[Dict[str, Any]] = None,
) -> None:
    """
    Set up SQLAlchemy instrumentation for dodo application.
...
def teardown_dodo_db_instrumentation() -> None:
    """Tear down SQLAlchemy instrumentation for dodo application."""
...
def configure_dodo_db_instrumentation(**kwargs) -> None:
    """
    Configure SQLAlchemy instrumentation for dodo application.
...
def setup_fastapi_db_instrumentation(app, **config_kwargs):
    ...
    async def startup_db_instrumentation():
        setup_dodo_db_instrumentation(**config_kwargs)
