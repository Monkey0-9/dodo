...
from dodo.helpers.datetime_helpers import ns_to_ms
from dodo.log import get_logger
from dodo.otel.context import add_ctx_attribute, get_ctx_attributes
...
def get_dodo_meter() -> Meter:
    """Returns the global dodo meter if metrics are initialized."""
