...
from dodo.otel.resource import get_resource, is_pytest_environment
...
def setup_tracing(
    ...
    if settings.sqlalchemy_tracing:
        ...
        try:
            ...
            setup_dodo_db_instrumentation(enable_joined_monitoring=True)
        except Exception as e:
            # Log but continue if our custom instrumentation fails
            logger.warning(f"Failed to setup dodo DB instrumentation: {e}")
