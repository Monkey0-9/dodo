...
class DynamicMultiAgent(BaseAgent):
        ...
        **kwargs,
        ...
        try:
            for _ in range(self.max_turns):
                ...
                responses = Message.to_dodo_messages_from_list(manager_agent.last_response_messages)
                ...
                responses = Message.to_dodo_messages_from_list(
        ...
        return dodoUsageStatistics(**total_usage.model_dump(), step_count=step_count)
    ...
    def load_participant_agent(self, agent_id: str) -> dodoAgent:
