...
def load_multi_agent(
    ...
    match group.manager_type:
        case ManagerType.round_robin:
            from dodo.groups.round_robin_multi_agent import RoundRobinMultiAgent
        ...
        case ManagerType.dynamic:
            from dodo.groups.dynamic_multi_agent import DynamicMultiAgent
        ...
        case ManagerType.supervisor:
            from dodo.groups.supervisor_multi_agent import SupervisorMultiAgent
