...
from dodo.schemas.openai.chat_completion_response import ChatCompletionResponse, Choice
...
def convert_response_format_to_responses_api(
    ...
    """
    Convert dodo's ResponseFormatUnion to OpenAI Responses API text.format structure.
    ...
    Args:
        response_format: dodo ResponseFormatUnion object
