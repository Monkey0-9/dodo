...
class LLMClientBase:
    ...
    def extract_usage_statistics(self, response_data: Optional[dict], llm_config: LLMConfig) -> dodoUsageStatistics:
        """Provider-specific usage parsing hook (override in subclasses). Returns dodoUsageStatistics."""
    ...
    async def request_async_with_telemetry(self, request_data: dict, llm_config: LLMConfig) -> dict:
        ...
        dodo_TELEMETRY_PROVIDER_TRACE_BACKEND.
        """
