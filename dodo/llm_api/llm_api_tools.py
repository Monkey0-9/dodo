...
from dodo.llm_api.openai import (
    build_openai_chat_completions_request,
    openai_chat_completions_process_stream,
    openai_chat_completions_request,
    prepare_openai_payload,
)
from dodo.local_llm.chat_completion_proxy import get_chat_completion
...
from dodo.schemas.enums import LLMCallType, ProviderCategory
...
from dodo.settings import ModelSettings
...
def create(
    ...
    if llm_config.model_endpoint_type in ["openai", "openrouter"]:
        if model_settings.openai_api_key is None and llm_config.model_endpoint == "https://api.openai.com/v1":
            ...
            raise dodoConfigurationError(message="OpenAI key is missing from dodo config file", missing_fields=["openai_api_key"])
