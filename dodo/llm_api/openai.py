...
from dodo.helpers.datetime_helpers import timestamp_to_datetime
from dodo.llm_api.helpers import add_inner_thoughts_to_functions, convert_to_structured_output
from dodo.llm_api.openai_client import (
...
from dodo.schemas.message import Message as PydanticMessage, MessageRole as _MessageRole
...
from dodo.streaming_interface import AgentChunkStreamingInterface, AgentRefreshStreamingInterface
from dodo.utils import get_tool_call_id, smart_urljoin
...
def openai_chat_completions_process_stream(
    ...
    To "stream" the response in dodo, we want to call a streaming-compatible interface function
...
def openai_chat_completions_request_stream(
    ...
    # In dodo config the address for vLLM is w/o a /v1 suffix for simplicity
