...
from dodo.llm_api.zai_client import is_zai_reasoning_model
...
class FireworksClient(OpenAIClient):
    """Fireworks AI client â€” serves GLM-5 via OpenAI-compatible API."""
    ...
    def build_request_data(
        ...
        # Sanitize empty text content â€” rejects empty text blocks
        if "messages" in data:
