...
class ZAIClient(OpenAIClient):
    ...
    def build_request_data(
        ...
        # Strip reasoning fields from input messages â€” ZAI rejects these as invalid parameters (error 1210)
        if "messages" in data:
        ...
        # Sanitize empty text content â€” ZAI rejects empty text blocks
        if "messages" in data:
            for msg in data["messages"]:
