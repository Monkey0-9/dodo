...
from dodo.schemas.provider_trace import ProviderTraceMetadata as PydanticProviderTraceMetadata
...
class ProviderTraceMetadata(SqlalchemyBase, OrganizationMixin):
    ...
    source: Mapped[Optional[str]] = mapped_column(
        String, nullable=True, doc="Source service that generated this trace (dodo-server, lettuce-py)"
    )
