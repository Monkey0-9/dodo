...
from dodo.utils import smart_urljoin

logger = get_logger(__name__)


class BasetenProvider(OpenAIProvider):
    """Baseten serverless provider â€” OpenAI-compatible inference."""
    ...
    async def check_api_key(self):
        ...
        try:
            ...
            if not data:
                raise ValueError("Baseten returned no models â€” check API key")
        except httpx.HTTPStatusError as e:
            from dodo.errors import ErrorCode, LLMAuthenticationError
