...
from dodo.constants import MIN_CONTEXT_WINDOW
from dodo.errors import ErrorCode, LLMAuthenticationError, LLMPermissionDeniedError
...
from dodo.schemas.providers.openai import OpenAIProvider
...
class TogetherProvider(OpenAIProvider):
    ...
    async def list_embedding_models_async(self) -> list[EmbeddingConfig]:
        logger.warning(
            "dodo does not currently support listing embedding models for Together. Please "
