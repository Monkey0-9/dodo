...
from dodo.constants import DEFAULT_EMBEDDING_CHUNK_SIZE, LLM_MAX_CONTEXT_WINDOW
from dodo.errors import ErrorCode, LLMAuthenticationError, LLMError, LLMPermissionDeniedError
...
class OpenAIProvider(Provider):
    ...
    async def get_default_max_output_tokens_async(self, model_name: str) -> int:
        ...
        """
        from dodo.model_specs.litellm_model_specs import get_max_output_tokens
    ...
    async def _get_models_async(self) -> list[dict]:
        ...
        try:
            ...
            # Baseten dedicated deployments don't expose /models â€” return empty list
    ...
    async def _list_llm_models(self, data: list[dict]) -> list[LLMConfig]:
        """
        This handles filtering out LLM Models by provider that meet dodo's requirements.
        """
        configs = []
        for model in data:
    ...
    def _set_model_parameter_tuned_defaults(model_name: str, llm_config: LLMConfig):
        ...
        if "gpt-4o" in model_name or "gpt-4.1-mini" in model_name or model_name == "dodo-free":
    ...
    async def get_model_context_window_size_async(self, model_name: str) -> int | None:
        ...
        """
        from dodo.model_specs.litellm_model_specs import get_context_window
