...
class IdentityBase(dodoBase):
    __id_prefix__ = PrimitiveType.IDENTITY.value


class IdentityProperty(dodoBase):
...
class PaginatedIdentities(dodoBase):
