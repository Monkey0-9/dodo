...
class Provider(ProviderBase):
    ...
    def cast_to_subtype(self):
        match self.provider_type:
            case ProviderType.dodo:
                return dodoProvider(**self.model_dump(exclude_none=True))
    ...
    def list_embedding_models(self):
        return [
            EmbeddingConfig(
                ...
                embedding_endpoint="https://embeddings.dodo.ai",
                embedding_dim=1024,
...
class OpenAIProvider(Provider):
    ...
    def check_api_key(self):
        from dodo.llm_api.openai import openai_check_valid_api_key

        openai_check_valid_api_key(self.base_url, self.api_key)

    def _get_models(self) -> List[dict]:
        from dodo.llm_api.openai import openai_get_model_list
    ...
    async def _get_models_async(self) -> List[dict]:
        from dodo.llm_api.openai import openai_get_model_list_async
...
class MistralProvider(Provider):
    ...
    def list_llm_models(self) -> List[LLMConfig]:
        from dodo.llm_api.mistral import mistral_get_model_list
...
class TogetherProvider(OpenAIProvider):
    ...
    def _list_llm_models(self, models) -> List[LLMConfig]:
        ...
        for model in data:
            ...
            # Skip models that are too small for dodo
...
class GoogleAIProvider(Provider):
    ...
    def check_api_key(self):
        from dodo.llm_api.google_ai_client import google_ai_check_valid_api_key

        google_ai_check_valid_api_key(self.api_key)

    def list_llm_models(self):
        from dodo.llm_api.google_ai_client import google_ai_get_model_list
    ...
    async def list_llm_models_async(self):
        ...
        from dodo.llm_api.google_ai_client import google_ai_get_model_list_async
    ...
    def get_model_context_window(self, model_name: str) -> Optional[int]:
        from dodo.llm_api.google_ai_client import google_ai_get_model_context_window
    ...
    async def get_model_context_window_async(self, model_name: str) -> Optional[int]:
        from dodo.llm_api.google_ai_client import google_ai_get_model_context_window_async
...
class GoogleVertexProvider(Provider):
    ...
    def list_llm_models(self) -> List[LLMConfig]:
        from dodo.llm_api.google_constants import GOOGLE_MODEL_TO_CONTEXT_LENGTH
    ...
    def list_embedding_models(self) -> List[EmbeddingConfig]:
        from dodo.llm_api.google_constants import GOOGLE_EMBEDING_MODEL_TO_DIM
...
class AzureProvider(Provider):
    ...
    base_url: str = Field(
        ..., description="Base URL for the Azure API endpoint. This should be specific to your org, e.g. `https://dodo.openai.azure.com`."
    )
    ...
    def list_llm_models(self) -> List[LLMConfig]:
        from dodo.llm_api.azure_openai import azure_openai_get_chat_completion_model_list
    ...
    def list_embedding_models(self) -> List[EmbeddingConfig]:
        from dodo.llm_api.azure_openai import azure_openai_get_embeddings_model_list
...
class BedrockProvider(Provider):
    ...
    async def list_llm_models_async(self) -> List[LLMConfig]:
        from dodo.llm_api.aws_bedrock import bedrock_get_model_list_async
    ...
    def get_model_context_window(self, model_name: str) -> Optional[int]:
        ...
        from dodo.llm_api.aws_bedrock import bedrock_get_model_context_window
