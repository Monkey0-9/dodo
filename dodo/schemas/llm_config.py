...
from dodo.model_aliases import get_deprecated_google_handle_replacement, get_deprecated_google_model_replacement
from dodo.schemas.enums import AgentType, ProviderCategory
from dodo.schemas.response_format import ResponseFormatUnion

if TYPE_CHECKING:
    from dodo.schemas.model import ModelSettings
...
class LLMConfig(BaseModel):
    ...
    .. deprecated::
        ...
        Use the schemas in dodo.schemas.model (ModelSettings, OpenAIModelSettings, etc.) instead.
    ...
    def validate_codex_reasoning_effort(cls, values):
        ...
        """
        from dodo.llm_api.openai_client import does_not_support_minimal_reasoning
    ...
    def default_config(cls, model_name: str):
        ...
        Args:
            model_name (str): The name of the model (gpt-4, gpt-4o-mini, dodo).
        """
        if model_name == "gpt-4":
            return cls(
                model="gpt-4",
    ...
    def _to_model_settings(self) -> "ModelSettings":
        ...
        """
        from dodo.schemas.model import (
        ...
        if self.model_endpoint_type == "openai":
            ...
            from dodo.schemas.model import ZAIThinking
            ...
            from dodo.schemas.model import BasetenModelSettings
    ...
    def apply_reasoning_setting_to_config(cls, config: "LLMConfig", reasoning: bool, agent_type: Optional["AgentType"] = None):
        ...
        For AgentType.dodo_v1_agent, we enforce stricter semantics:
        ...
        """
        from dodo.llm_api.openai_client import does_not_support_minimal_reasoning, supports_none_reasoning_effort

        # V1 agent policy: do not allow simulated reasoning for non-native models
        if agent_type is not None and agent_type == AgentType.dodo_v1_agent:
