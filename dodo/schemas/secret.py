...
from dodo.helpers.crypto_utils import CryptoUtils
from dodo.log import get_logger
from dodo.utils import bounded_gather
...
class Secret(BaseModel):
    ...
    def from_plaintext(cls, value: Optional[str]) -> "Secret":
        ...
        If dodo_ENCRYPTION_KEY is configured, the value is encrypted.
        ...
        try:
            ...
            if "No encryption key configured" in str(e):
                logger.warning(
                    ...
                    "Set dodo_ENCRYPTION_KEY environment variable to enable encryption."
                )
    ...
    def get_plaintext(self) -> Optional[str]:
        ...
        try:
            ...
            # here â€” it false-positives on long alphanumeric API keys that happen to be
    ...
    def __get_pydantic_core_schema__(cls, source_type: Any, handler) -> core_schema.CoreSchema:
        ...
        - Deserialize: Convert encrypted strings from DB â†’ Secret objects
        - Serialize: Convert Secret objects â†’ encrypted strings for DB
        """
