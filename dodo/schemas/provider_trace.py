...
class ProviderTrace(BaseProviderTrace):
    """
    dodo's internal representation of a provider trace.
    ...
    Attributes:
        ...
        source (str): Source service that generated this trace (dodo-server, lettuce-py).
    ...
    source: Optional[str] = Field(None, description="Source service that generated this trace (dodo-server, lettuce-py)")
