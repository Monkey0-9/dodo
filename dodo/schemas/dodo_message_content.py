...
class dodoImage(ImageSource):
    type: Literal[ImageSourceType.dodo] = Field(default=ImageSourceType.dodo, description="The source type for the image.")
...
ImageSourceUnion = Annotated[Union[UrlImage, Base64Image, dodoImage], Field(discriminator="type")]
...
dodoUserMessageContentUnion = Annotated[
    Union[TextContent, ImageContent],
    Field(discriminator="type"),
]


def create_dodo_user_message_content_union_schema():
    return {
        "oneOf": [
...
def get_dodo_user_message_content_union_str_json_schema():
    return {
        "anyOf": [
            {
                "type": "array",
                "items": {
                    "$ref": "#/components/schemas/dodoUserMessageContentUnion",
                },
            },
            {"type": "string"},
        ],
...
dodoToolReturnContentUnion = Annotated[
    Union[TextContent, ImageContent],
    Field(discriminator="type"),
]


def create_dodo_tool_return_content_union_schema():
    return {
        "oneOf": [
            {"$ref": "#/components/schemas/TextContent"},
            {"$ref": "#/components/schemas/ImageContent"},
...
def get_dodo_tool_return_content_union_str_json_schema():
        ...
        "anyOf": [
            {
                "type": "array",
                "items": {
                    "$ref": "#/components/schemas/dodoToolReturnContentUnion",
                },
            },
            {"type": "string"},
        ],
...
dodoAssistantMessageContentUnion = Annotated[
    Union[TextContent],
    Field(discriminator="type"),
]


def create_dodo_assistant_message_content_union_schema():
    return {
        "oneOf": [
            {"$ref": "#/components/schemas/TextContent"},
        ],
...
def get_dodo_assistant_message_content_union_str_json_schema():
    return {
        "anyOf": [
            {
                "type": "array",
                "items": {
                    "$ref": "#/components/schemas/dodoAssistantMessageContentUnion",
                },
            },
            {"type": "string"},
        ],
...
dodoMessageContentUnion = Annotated[
    Union[
        TextContent,
        ImageContent,
        ToolCallContent,
...
def create_dodo_message_content_union_schema():
    return {
        "oneOf": [
            {"$ref": "#/components/schemas/TextContent"},
            {"$ref": "#/components/schemas/ImageContent"},
...
def get_dodo_message_content_union_str_json_schema():
    return {
        "anyOf": [
            {
                "type": "array",
                "items": {
                    "$ref": "#/components/schemas/dodoMessageContentUnion",
                },
            },
            {"type": "string"},
        ],
