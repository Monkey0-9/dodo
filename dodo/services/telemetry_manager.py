...
from dodo.services.provider_trace_backends import get_provider_trace_backend, get_provider_trace_backends
from dodo.settings import telemetry_settings
...
class TelemetryManager:
    ...
    Configure via dodo_TELEMETRY_PROVIDER_TRACE_BACKEND (comma-separated):
    ...
    Example: dodo_TELEMETRY_PROVIDER_TRACE_BACKEND=postgres,clickhouse
    ...
    async def create_provider_trace_async(
        ...
        # Set source if not already set (use dodo_TELEMETRY_SOURCE, fallback to DD_SERVICE)
