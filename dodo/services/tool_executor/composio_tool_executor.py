...
from dodo.functions.composio_helpers import execute_composio_action_async, generate_composio_action_from_func_name
from dodo.helpers.composio_helpers import get_composio_api_key_async
    ...
    async def execute(
        ...
        if agent_state is None:
            return ToolExecutionResult(
                status="error",
                func_return="Agent state is required for external Composio tools. Please contact dodo support if you see this error.",
            )
