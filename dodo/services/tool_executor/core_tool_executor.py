...
class dodoCoreToolExecutor(ToolExecutor):
    """Executor for dodo core tools with direct implementation of functions."""
    ...
    async def conversation_search(
        ...
        try:
            ...
            from dodo.constants import CONVERSATION_SEARCH_TOOL_NAME
