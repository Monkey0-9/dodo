    ...
    async def _sync_block_to_postgres(
        ...
        async with db_registry.async_session() as session:
            ...
            if block:
                ...
                from dodo.schemas.block import BaseBlock
    ...
    async def enable_git_memory_for_agent(
        ...
        if await self._is_git_enabled_for_agent(agent_id, actor):
            try:
                ...
                # because labels like "dodo/dodo_town" contain "/" but aren't
        ...
        # Use startswith check (not "/" presence) because labels like "dodo/dodo_town"
