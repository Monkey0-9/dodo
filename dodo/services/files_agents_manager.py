...
from dodo.orm.file import FileMetadata as FileMetadataModel
from dodo.orm.files_agents import FileAgent as FileAgentModel
from dodo.otel.tracing import trace_method
from dodo.schemas.block import Block as PydanticBlock, FileBlock as PydanticFileBlock
from dodo.schemas.file import FileAgent as PydanticFileAgent, FileMetadata
...
class FileAgentManager:
    ...
    async def attach_file(
        ...
        *,
        ...
        â€¢ If the row already exists â†’ update `is_open`, `visible_content`
          and always refresh `last_accessed_at`.
        â€¢ Otherwise create a brand-new association.
        â€¢ If is_open=True, enforces max_files_open using LRU eviction.
