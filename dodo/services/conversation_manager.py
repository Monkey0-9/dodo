...
from dodo.orm.block import Block as BlockModel
from dodo.orm.blocks_conversations import BlocksConversations
from dodo.orm.conversation import Conversation as ConversationModel
from dodo.orm.conversation_messages import ConversationMessage as ConversationMessageModel
...
class ConversationManager:
    ...
    async def compile_and_save_system_message_for_conversation(
        ...
        message â€” used both at conversation creation time and as a fallback
    ...
    async def list_conversation_messages(
        ...
        async with db_registry.async_session() as session:
            ...
            # Convert to dodoMessages (reverse=False keeps sub-messages in natural order)
            return PydanticMessage.to_dodo_messages_from_list(
    ...
    async def _create_isolated_blocks(
        ...
        Raises:
            dodoInvalidArgumentError: If a block label is not found on the agent
        """
