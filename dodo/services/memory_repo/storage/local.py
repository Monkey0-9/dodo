...
class LocalStorageBackend(StorageBackend):
    ...
    ~/.dodo/memfs/. This enables git-backed memory for self-hosted
    ...
    def __init__(
        ...
        Args:
            base_path: Base directory for storage (default: ~/.dodo/memfs)
            prefix: Prefix for all paths in this backend (default: "repository")
        """
        if base_path is None:
            base_path = os.path.expanduser("~/.dodo/memfs")
