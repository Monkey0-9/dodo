...
on the local filesystem (~/.dodo/memfs/ by default). This enables
...
from dodo.schemas.memory_repo import MemoryCommit
from dodo.schemas.user import User as PydanticUser
from dodo.services.memory_repo.block_markdown import parse_block_markdown, serialize_block
from dodo.services.memory_repo.git_operations import GitOperations
...
DEFAULT_LOCAL_PATH = os.path.expanduser("~/.dodo/memfs")
...
class MemfsClient:
    ...
    def __init__(self, base_url: str | None = None, local_path: str | None = None, timeout: float = 120.0):
        ...
        Args:
            ...
            local_path: Path for local storage (default: ~/.dodo/memfs)
    ...
    async def create_repo_async(
        ...
        return await self.git.create_repo(
            ...
            author_email=f"{actor.id}@dodo.ai",
        )
    ...
    async def update_block_async(
        ...
        *,
        ...
        Returns:
            Commit details
        """
        from dodo.schemas.memory_repo import FileChange
