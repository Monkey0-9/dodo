...
from dodo.services.summarizer.summarizer_config import CompactionSettings, get_default_prompt_for_mode
...
async def self_summarize_all(
    ...
    # This mirrors the logic in dodo_agent_v3.py step processing
    ...
    from dodo.services.summarizer.summarizer import _run_summarizer_request
