...
from dodo.services.summarizer.self_summarizer import self_summarize_all, self_summarize_sliding_window
from dodo.services.summarizer.summarizer_all import summarize_all
from dodo.services.summarizer.summarizer_config import CompactionSettings, get_default_prompt_for_mode, get_default_summarizer_model
from dodo.services.summarizer.summarizer_sliding_window import (
    count_tokens,
...
async def build_summarizer_llm_config(
    ...
    if agent_llm_config.handle and agent_llm_config.handle.startswith("dodo/auto"):
    ...
    try:
        ...
        # (safety net for stale compaction_settings that still reference dodo/auto)
        if summarizer_config.model and summarizer_config.model.startswith("dodo/auto"):
            try:
