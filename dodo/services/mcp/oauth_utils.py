...
from dodo.schemas.mcp import MCPOAuthSessionUpdate
...
async def create_oauth_provider(
    ...
    DEPRECATED: Use ServerSideOAuth from dodo.services.mcp.server_side_oauth instead.
    This function is kept for backwards compatibility but will be removed in a future version.
    """
    logger.warning("create_oauth_provider is deprecated. Use ServerSideOAuth from dodo.services.mcp.server_side_oauth instead.")
