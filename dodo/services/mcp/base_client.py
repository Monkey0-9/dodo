...
from dodo.functions.mcp_client.types import BaseServerConfig
...
class AsyncBaseMCPClient:
    ...
    async def connect_to_server(self):
        try:
            ...
            raise dodoMCPConnectionError(message=str(e), server_name=getattr(self.server_config, "server_name", None)) from e
