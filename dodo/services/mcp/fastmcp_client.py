...
from dodo.errors import dodoMCPConnectionError
from dodo.functions.mcp_client.types import SSEServerConfig, StreamableHTTPServerConfig
from dodo.log import get_logger
from dodo.services.mcp.base_client import _log_mcp_tool_error
    ...
    async def connect_to_server(self):
        ...
        try:
            ...
            if e.response.status_code == 401:
                raise dodoMCPConnectionError(message="401 Unauthorized", server_name=self.server_config.server_name) from e
            ...
            raise dodoMCPConnectionError(message=str(e), server_name=self.server_config.server_name) from e
