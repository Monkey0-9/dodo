...
from dodo.functions.mcp_client.types import (
    MCPServerType,
    MCPTool,
    MCPToolHealth,
    SSEServerConfig,
...
from dodo.functions.schema_generator import normalize_mcp_schema
...
from dodo.orm.mcp_oauth import MCPOAuth, OAuthSessionStatus
from dodo.orm.mcp_server import MCPServer as MCPServerModel, MCPTools as MCPToolsModel
from dodo.orm.tool import Tool as ToolModel
from dodo.schemas.mcp import (
    MCPOAuthSession,
...
from dodo.schemas.mcp_server import CreateMCPServerRequest, CreateSSEMCPServer, CreateStdioMCPServer, CreateStreamableHTTPMCPServer
...
from dodo.services.mcp.fastmcp_client import AsyncFastMCPSSEClient, AsyncFastMCPStreamableHTTPClient
from dodo.services.mcp.server_side_oauth import ServerSideOAuth
...
from dodo.utils import enforce_types, printd, safe_create_task
...
class MCPServerManager:
    ...
    async def add_tool_from_mcp_server(self, mcp_server_id: str, mcp_tool_name: str, actor: PydanticUser) -> PydanticTool:
        """Add a tool from an MCP server to the dodo tool registry."""
    ...
    async def handle_oauth_flow(
        ...
        from dodo.services.mcp.oauth_utils import oauth_stream_event
        ...
        # Check if request is from dodo-code CLI (uses web callback for OAuth)
        is_dodo_code_request = http_request and http_request.headers and http_request.headers.get("x-dodo-source", "") == "dodo-code"
