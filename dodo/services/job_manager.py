...
from dodo.orm.job import Job as JobModel
...
class JobManager:
    ...
    async def get_run_messages(
        ...
        Returns:
            List of dodoMessages associated with the job
        ...
        logger.info("request_config", request_config)

        messages = PydanticMessage.to_dodo_messages_from_list(
            messages=messages,
    ...
    async def _get_run_request_config(self, run_id: str) -> dodoRequestConfig:
        """
        ...
        async with db_registry.async_session() as session:
            ...
            request_config = job.request_config or dodoRequestConfig()
