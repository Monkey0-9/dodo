...
from dodo.services.clickhouse_provider_traces import ClickhouseProviderTraceReader
from dodo.services.provider_trace_backends.base import ProviderTraceBackendClient
from dodo.settings import settings

if TYPE_CHECKING:
    from dodo.schemas.llm_trace import LLMTrace
...
class ClickhouseProviderTraceBackend(ProviderTraceBackendClient):
    ...
    async def create_async(
        ...
        try:
            from dodo.services.llm_trace_writer import get_llm_trace_writer
