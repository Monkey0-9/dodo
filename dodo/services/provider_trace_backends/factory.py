...
from dodo.services.provider_trace_backends.base import ProviderTraceBackend, ProviderTraceBackendClient
...
def _create_backend(backend: ProviderTraceBackend | str) -> ProviderTraceBackendClient:
    ...
    match backend_str:
        ...
        case "postgres" | _:
            from dodo.services.provider_trace_backends.postgres import PostgresProviderTraceBackend
