...
from dodo.constants import MODAL_DEFAULT_TOOL_NAME
...
class AsyncToolSandboxModal(AsyncToolSandboxBase):
    ...
    async def _wait_for_modal_function_deployment(self, timeout: int = 60):
        ...
        from dodo.helpers.tool_helpers import generate_modal_function_name
    ...
    async def run(
        ...
        try:
            ...
            if additional_env_vars is None:
                ...
                dodo_api_key = additional_env_vars.get("dodo_SECRET_API_KEY", None)
