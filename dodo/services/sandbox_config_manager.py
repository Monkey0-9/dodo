...
from dodo.orm.sandbox_config import SandboxConfig as SandboxConfigModel, SandboxEnvironmentVariable as SandboxEnvVarModel
from dodo.otel.tracing import trace_method
from dodo.schemas.enums import PrimitiveType, SandboxType
from dodo.schemas.environment_variables import (
    SandboxEnvironmentVariable as PydanticEnvVar,
    SandboxEnvironmentVariableCreate,
    SandboxEnvironmentVariableUpdate,
)
from dodo.schemas.sandbox_config import (
    E2BSandboxConfig,
    LocalSandboxConfig,
    ModalSandboxConfig,
...
from dodo.utils import enforce_types, printd
    ...
    def get_or_create_default_sandbox_config(self, sandbox_type: SandboxType, actor: PydanticUser) -> PydanticSandboxConfig:
        ...
        if not sandbox_config:
            ...
            if sandbox_type == SandboxType.E2B:
                ...
                # LOCAL sandbox type
                default_local_sandbox_path = dodo_TOOL_EXECUTION_DIR
