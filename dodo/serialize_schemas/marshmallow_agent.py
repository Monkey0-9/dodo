...
import dodo
from dodo.orm import Agent, Message as MessageModel
from dodo.schemas.agent import AgentState as PydanticAgentState
from dodo.schemas.user import User
from dodo.serialize_schemas.marshmallow_agent_environment_variable import SerializedAgentEnvironmentVariableSchema
from dodo.serialize_schemas.marshmallow_base import BaseSchema
from dodo.serialize_schemas.marshmallow_block import SerializedBlockSchema
from dodo.serialize_schemas.marshmallow_custom_fields import EmbeddingConfigField, LLMConfigField, ToolRulesField
from dodo.serialize_schemas.marshmallow_message import SerializedMessageSchema
from dodo.serialize_schemas.marshmallow_tag import SerializedAgentTagSchema
from dodo.serialize_schemas.marshmallow_tool import SerializedToolSchema
...
class MarshmallowAgentSchema(BaseSchema):
    ...
    def sanitize_ids(self, data: Dict, **kwargs):
        ...
        data[self.FIELD_VERSION] = dodo.__version__
    ...
    def check_version(self, data, **kwargs):
        ...
        if version != dodo.__version__:
            print(f"Version mismatch: expected {dodo.__version__}, got {version}")
