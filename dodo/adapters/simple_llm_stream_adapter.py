...
from dodo.interfaces.anthropic_parallel_tool_call_streaming_interface import SimpleAnthropicStreamingInterface
from dodo.interfaces.gemini_streaming_interface import SimpleGeminiStreamingInterface
...
class SimpleLLMStreamAdapter(dodoLLMStreamAdapter):
    """
    ...
    ) -> AsyncGenerator[dodoMessage, None]:
        """
        ...
        try:
            ...
            if hasattr(self.interface, "final_response") and self.interface.final_response is not None:
                ...
                if incomplete_reason == "max_output_tokens":
                    ...
                    # Unknown incomplete reason â€” preserve it as-is for diagnostics
