...
class dodoLLMAdapter(ABC):
    ...
    def __init__(
        ...
        self.usage: dodoUsageStatistics = dodoUsageStatistics()
    ...
    async def invoke_llm(
        ...
        Yields:
            dodoMessage: Chunks of data for streaming adapters, or None for blocking adapters
        """
