...
import dodo.server.ws_api.protocol as protocol
from dodo.helpers.json_helpers import json_dumps, json_loads
from dodo.server.constants import WS_CLIENT_TIMEOUT, WS_DEFAULT_PORT
from dodo.server.utils import condition_to_stop_receiving, print_server_response
...
async def basic_cli_client():
    """Basic example of a dodo CLI client that connects to a dodo server.py process via WebSockets
