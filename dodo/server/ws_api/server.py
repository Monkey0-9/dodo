...
from dodo.server.constants import WS_DEFAULT_PORT
from dodo.server.server import SyncServer
from dodo.server.ws_api.interface import SyncWebSocketInterface
...
class WebSocketServer:
    ...
    async def start_server(self):
        ...
        # and https://github.com/dodo-ai/dodo/issues/471
