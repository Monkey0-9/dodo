...
class ChatCompletionsStreamingInterface(AgentChunkStreamingInterface):
    ...
    - function_message, internal_monologue: Handle LLM â€œfunction callsâ€ and
      â€œreasoningâ€ messages for non-streaming contexts.
    """
    ...
    async def _create_generator(
        self,
    ) -> AsyncGenerator[Union[dodoMessage, MessageStreamStatus], None]:
        """
    ...
    def _push_to_buffer(
        ...
        """m
        Add an item (a dodoMessage, status marker, or partial chunk)
