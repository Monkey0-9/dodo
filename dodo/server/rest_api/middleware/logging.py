...
from dodo.log_context import clear_log_context, update_log_context
...
class LoggingMiddleware(BaseHTTPMiddleware):
    ...
    - dodo primitive IDs: agent_id, tool_id, block_id, etc. from URL paths
    ...
    async def dispatch(self, request: Request, call_next: Callable):
        ...
        try:
            ...
            custom_context = {}
            if hasattr(exc, "__dodo_context__"):
                custom_context = exc.__dodo_context__
