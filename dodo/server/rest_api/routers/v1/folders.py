...
from dodo.errors import dodoInvalidArgumentError, dodoUnsupportedFileUploadError
from dodo.helpers.pinecone_utils import (
    delete_file_records_from_pinecone_index,
    delete_source_records_from_pinecone_index,
    should_use_pinecone,
)
from dodo.helpers.tpuf_client import should_use_tpuf
...
from dodo.schemas.enums import DuplicateFileHandling, FileProcessingStatus
from dodo.schemas.file import FileMetadata
from dodo.schemas.folder import Folder
...
from dodo.services.file_processor.file_processor import FileProcessor
from dodo.services.file_processor.file_types import get_allowed_media_types, get_extension_to_mime_type_map, register_mime_types
from dodo.services.file_processor.parser.markitdown_parser import MarkitdownFileParser
from dodo.services.file_processor.parser.mistral_parser import MistralFileParser
from dodo.settings import settings
from dodo.utils import safe_create_file_processing_task, safe_create_task, sanitize_filename
from dodo.validators import FileId, FolderId
...
async def upload_file_to_folder(
    ...
    if media_type not in allowed_media_types:
        raise dodoUnsupportedFileUploadError(
            message=(
...
async def load_file_to_source_cloud(
    ...
    if should_use_tpuf():
        from dodo.services.file_processor.embedder.turbopuffer_embedder import TurbopufferEmbedder
