...
from dodo.schemas.mcp_server import (
...
from dodo.services.mcp.oauth_utils import drill_down_exception, oauth_stream_event
    ...
    async def oauth_stream_generator(
        ...
        try:
            ...
            try:
                ...
                return
            except (ConnectionError, dodoMCPConnectionError):
