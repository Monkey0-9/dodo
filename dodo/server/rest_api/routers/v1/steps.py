...
@router.get("/{step_id}/messages", response_model=List[dodoMessageUnion], operation_id="list_messages_for_step")
async def list_messages_for_step(
    ...
    return Message.to_dodo_messages_from_list(messages)
