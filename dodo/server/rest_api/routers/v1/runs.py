...
from dodo.services.clickhouse_otel_traces import ClickhouseOtelTracesReader
...
async def retrieve_trace_for_run(
    ...
    if not settings.clickhouse_endpoint:
        raise HTTPException(
            status_code=501,
            detail="OTEL traces require ClickHouse. Set dodo_CLICKHOUSE_ENDPOINT and configure ClickHouse connection.",
        )
