...
def add_exception_context(exception: Exception, **context) -> Exception:
    ...
    This attaches a __dodo_context__ attribute to the exception with structured data.
    ...
    """
    if not hasattr(exception, "__dodo_context__"):
        exception.__dodo_context__ = {}
    exception.__dodo_context__.update(context)
    return exception
