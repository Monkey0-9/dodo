...
from dodo.jobs.helpers import map_anthropic_batch_job_status_to_job_status, map_anthropic_individual_batch_item_status_to_job_status
...
@trace_method
async def poll_running_llm_batches(server: "SyncServer") -> List[dodoBatchResponse]:
    """
        ...
        if item_updates:
            ...
            async def _resume(batch_row: LLMBatchJob) -> dodoBatchResponse:
                ...
                return await runner.resume_step_after_request(
                    dodo_batch_id=batch_row.dodo_batch_job_id,
