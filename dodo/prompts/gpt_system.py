...
from dodo.prompts.system_prompts import SYSTEM_PROMPTS
...
def get_system_text(key):
    ...
    # fallback to user custom prompts in ~/.dodo/system_prompts/*.txt
    filename = f"{key}.txt"
    user_system_prompts_dir = os.path.join(dodo_DIR, "system_prompts")
