...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("llm_config", dodo.orm.custom_columns.LLMConfigColumn(), nullable=True),
        sa.Column("embedding_config", dodo.orm.custom_columns.EmbeddingConfigColumn(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(), nullable=True),
        sa.Column("tool_calls", dodo.orm.message.ToolCallColumn(), nullable=True),
