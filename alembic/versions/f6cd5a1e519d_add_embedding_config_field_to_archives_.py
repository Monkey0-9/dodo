...
def upgrade() -> None:
    ...
    op.add_column("archives", sa.Column("embedding_config", dodo.orm.custom_columns.EmbeddingConfigColumn(), nullable=True))
    ...
    default_config = EmbeddingConfig.default_config(model_name="dodo")
