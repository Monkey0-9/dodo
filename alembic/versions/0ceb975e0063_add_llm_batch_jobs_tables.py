...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("create_batch_response", dodo.orm.custom_columns.CreateBatchResponseColumn(), nullable=False),
        sa.Column("latest_polling_response", dodo.orm.custom_columns.PollBatchResponseColumn(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("llm_config", dodo.orm.custom_columns.LLMConfigColumn(), nullable=False),
        sa.Column("request_status", sa.String(), nullable=False),
        sa.Column("step_status", sa.String(), nullable=False),
        sa.Column("step_state", dodo.orm.custom_columns.AgentStepStateColumn(), nullable=False),
        sa.Column("batch_request_result", dodo.orm.custom_columns.BatchRequestResultColumn(), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.text("now()"), nullable=True),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.text("now()"), nullable=True),
        sa.Column("is_deleted", sa.Boolean(), server_default=sa.text("FALSE"), nullable=False),
        sa.Column("_created_by_id", sa.String(), nullable=True),
